/**
 * CXO-level output catalog for the Capital Posture Governance UX.
 * Captures how capital posture signals map into executive decision artifacts.
 */
...
export const cxoFunctionOutputs: CxoFunctionOutput[] = [
  {
    ...
    outputs: [
      ...
      "Budget planning export with capital posture narrative and citation-ready sources.",
  ...
  },
  {
    ...
    outputs: [
      "Roadmap posture toggles (growth vs. efficiency) with capital posture guidance.",
  ...
  },
  {
    ...
    outputs: [
      "One-page executive brief with capital posture summary, risks, and reversal triggers.",
