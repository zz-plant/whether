...
const hubLinks = [
  {
    href: "/start",
    label: "Start",
    description: "Orientation and guided entry.",
  },
  {
    href: "/use-cases",
    label: "Use Cases",
    description: "Role and situation pathways.",
  },
  {
    href: "/toolkits",
    label: "Toolkits",
    description: "Runnable templates and checklists.",
  },
  {
    href: "/learn",
    label: "Learn",
    description: "Concepts and diagnostics.",
  },
  {
    href: "/method",
    label: "Method",
    description: "Formulas, sources, and limits.",
  },
] as const;
