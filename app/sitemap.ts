...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const coreEntries: SitemapEntryDescriptor[] = [
    ...
    { path: "/plan", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.82 },
    ...
    { path: "/plan/toolkits", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.55 },
