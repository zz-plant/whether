...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const coreEntries: SitemapEntryDescriptor[] = [
    ...
    { path: "/decide", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.9 },
    { path: "/plan", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.85 },
    { path: "/learn", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.85 },
    { path: "/method", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.8 },
    { path: "/start", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.8 },
    { path: "/posture", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.8 },
    { path: "/use-cases", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.75 },
    { path: "/toolkits", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.75 },
    { path: "/library", lastModified: staticContentLastModified, changeFrequency: "monthly", priority: 0.7 },
