    ...
    <main className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-4 py-8 sm:px-6 sm:py-10">
      ...
      <section className="grid gap-3 sm:grid-cols-2">
        ...
        <Link href="/use-cases" className="weather-panel space-y-2 px-4 py-4">
          <h2 className="text-base font-semibold text-slate-100">Use-case guides</h2>
          <p className="text-sm text-slate-300">Role and stage-oriented guidance without legacy hub redirects.</p>
        </Link>
      </section>
      <section className="weather-panel flex flex-wrap items-center justify-between gap-3 px-6 py-4 text-sm">
        <p className="text-slate-300">For model logic and provenance, review Method.</p>
        <Link href="/method" className="weather-pill inline-flex min-h-[44px] items-center px-3 py-2">Open Method</Link>
      </section>
    </main>
  );
}
