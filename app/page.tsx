...
import { ExecutiveSnapshotPanel, WeeklyActionSummaryPanel, SignalMatrixPanel, HistoricalBanner } from "./components/reportSections";
...
export default async function HomePage({
  ...
  return (
    ...
    >
      <section aria-label="Read this first" className="weather-panel space-y-6 px-6 py-6">
